...
var _Creator = require("../User/Creator");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

// const Fundraiser = require('../User/fundraiser').fundRaiserSchema;
// import { Fund } from '../fund/fund';
var Schema = _mongoose["default"].Schema; //Project schema
...
ProjectSchema.methods.addFunder = function (fund) {
  ...
  this.raisedFunds += fund.amount; // Fund.find({ 'project': this._id }, (err, funds) => {
  //     if (err) return;
  //     funds.forEach(fund => {
...
var Project = _mongoose["default"].model("Project", ProjectSchema); // module.exports = {
//     Project,
//     ProjectSchema
// };
